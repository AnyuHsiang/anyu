...
function anyutv_post_image() {
	 ...
	 */
	$init = apply_filters( 'anyutv_post_image_popup_init', $default_init );
...
function anyutv_post_gallery() {
	...
	if ( ! $post_gallery ) {
		$post_gallery = anyutv_post_images( $post_id, 15 );
	}
	...
	$output = anyutv_get_gallery_html( $post_gallery );
 ...
 */
function anyutv_get_gallery_html( $images, $atts = array() ) {
	 ...
	 */
	$init = apply_filters( 'anyutv_post_gallery_slider_init', $default_slider_init );
	 ...
	 */
	$gall_init = apply_filters( 'anyutv_post_gallery_popup_init', $default_gall_init );
 ...
 */
function anyutv_post_images( $post_id = null, $limit = 1 ) {
